...
impl From<SubAccountCursor> for lava_app::ledger::account_set::LedgerSubAccountCursor {
...
impl
    From<(
        DateTime<Utc>,
        Option<DateTime<Utc>>,
        lava_app::ledger::account_set::LedgerAccountSetAndSubAccountsWithBalance,
                ...
                let res = app
                    ...
                    .paginated_account_set_and_sub_accounts_with_balance(
                        ...
                        es_entity::PaginatedQueryArgs {
                            first,
                            after: after
                                .map(lava_app::ledger::account_set::LedgerSubAccountCursor::from),
                        },
                    )
                    .await?;
...
impl From<lava_app::ledger::account_set::LedgerCashFlowStatement> for CashFlowStatement {
    fn from(profit_and_loss: lava_app::ledger::account_set::LedgerCashFlowStatement) -> Self {
        CashFlowStatement {
            name: profit_and_loss.name,
