...
pub(super) const BANK_CASH_ID: Uuid = uuid!("00000000-0000-0000-0000-000000000003");
pub(super) const BANK_CASH_NAME: &str = "Bank Cash";
pub(super) const BANK_CASH_CODE: &str = "BANK.CASH";
...
pub(super) const MAKE_PAYMENT_CODE: &str = "MAKE_PAYMENT";
