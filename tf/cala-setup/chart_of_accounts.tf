...
resource "cala_account_set" "credit_facilities_interest_revenue_control" {
  id                  = "00000000-0000-0000-0000-140000000002"
  journal_id          = cala_journal.journal.id
  name                = "Credit Facilities Interest Revenue Control Account"
  normal_balance_type = "CREDIT"
}
resource "cala_account_set_member_account_set" "credit_facilities_interest_revenue_control_in_revenue" {
  account_set_id        = cala_account_set.revenue.id
  member_account_set_id = cala_account_set.credit_facilities_interest_revenue_control.id
}

resource "cala_account_set" "credit_facilities_fee_revenue_control" {
  id                  = "00000000-0000-0000-0000-140000000003"
  journal_id          = cala_journal.journal.id
  name                = "Credit Facilities Fee Revenue Control Account"
  normal_balance_type = "CREDIT"
}
resource "cala_account_set_member_account_set" "credit_facilities_fee_revenue_control_in_revenue" {
  account_set_id        = cala_account_set.revenue.id
  member_account_set_id = cala_account_set.credit_facilities_fee_revenue_control.id
}
