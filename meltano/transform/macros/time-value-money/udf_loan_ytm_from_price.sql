{% macro create_udf_loan_ytm_from_price() %}

CREATE OR REPLACE FUNCTION {{target.schema}}.udf_loan_ytm_from_price (interest_rate FLOAT64, times ARRAY<FLOAT64>, cash_flows ARRAY<FLOAT64>)
RETURNS FLOAT64
LANGUAGE js
AS r"""
