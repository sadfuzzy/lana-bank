{% macro create_udf_loan_convexity() %}

CREATE OR REPLACE FUNCTION {{target.schema}}.udf_loan_convexity (interest_rate FLOAT64, times ARRAY<FLOAT64>, cash_flows ARRAY<FLOAT64>)
RETURNS FLOAT64
LANGUAGE js
AS r"""
